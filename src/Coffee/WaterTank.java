...
public class WaterTank {
    ...
    public WaterTank(int maxCapacity, int minCapacity, int waterQuantity) {
        ...
        if (maxCapacity < minCapacity) {
            throw new IllegalArgumentException("Invalid maxCapacity: must be greater than minCapacity");
        }
        if (waterQuantity < minCapacity || waterQuantity > maxCapacity) {
            throw new IllegalArgumentException("Invalid waterQuantity: must be between minCapacity and maxCapacity");
        }
